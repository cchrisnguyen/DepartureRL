...
class Departure:
    ...
    def __init__(self, task_name="departure", time=datetime(2020, 2, 2)):
        ...
        # Population dataset
        self.population = np.load("./data/population_density.npy")
    ...
    def step(self, action):
        ...
        for _ in range(10):
            ...
            self.aircraft.change_altitude(17*(action[2]+1)) # max: 50 ft/s
    ...
    def noise_pollution_level(self, latitude, longitude, altitude, threshold=50):
        if threshold == 70:
            impact_radius = 4000
        else:
...
# print(env.step([0.97730434, -0.8223864,   0.99455976]))
